...
const TechIcons = ({ icons, compact }) => {
    return (
        <div>
            {/* Section title with tech icon */}
            <h4 className={`text-xs font-semibold text-slate-400 uppercase tracking-wider ${compact ? 'mb-2' : 'mb-4'} flex items-center gap-2`}>
                <FaCode size={compact ? 10 : 12} className="text-slate-500" />
                Technologies
            </h4>
            ...
            >
                ...
                {icons.map((icon, i) => (
                    ...
                    >
                        ...
                        <i
                            className={`${icon.className} ${compact ? 'text-base' : 'text-lg'}`}
