...
const ContactTerminal = () => {
    ...
    return (
        ...
        >
            ...
            <div className="flex-1 p-6 overflow-y-auto text-green-200 bg-black/70 backdrop-blur-sm">
                <form className="space-y-5" onSubmit={onSubmit}>
                    <div className="flex flex-col">
                        ...
                        <input
                            ...
                            className="w-full p-3 mt-2 bg-black/80 text-green-200 border border-green-600 rounded-md focus:outline-none focus:ring-2 focus:ring-green-400 focus:border-green-400 shadow-inner"
                        />
                    </div>
                    ...
                    <div className="flex flex-col">
                        ...
                        <textarea
                            ...
                            className="w-full p-3 mt-2 bg-black/80 text-green-200 border border-green-600 rounded-md focus:outline-none focus:ring-2 focus:ring-green-400 focus:border-green-400 shadow-inner resize-none"
                        />
                    </div>
                    ...
                    <div className="flex justify-center pt-4">
                        <button
                            type="submit"
                            className="bg-green-900/20 text-green-300 font-mono px-8 py-3 rounded-md hover:bg-green-800/40 transition-all duration-300 transform hover:scale-105 border border-green-600 hover:border-green-400 shadow-[0_0_6px_rgba(0,255,0,0.25)]"
                        >
                            ./submit
                        </button>
                    </div>
