...
const SkillsCard = () => {
  ...
  return (
    <motion.div
      className="w-full max-w-6xl mx-auto p-6 md:p-10 border rounded-2xl shadow-[0_0_30px_rgba(120,119,198,0.15)] bg-gradient-to-br from-slate-900/90 to-slate-800/90 backdrop-blur-sm border-slate-700/50 mb-16"
    ...
    >
      ...
      >
        ...
        <div className="inline-flex items-center gap-3 mb-4 px-6 py-3 bg-gradient-to-r from-green-400/10 to-blue-400/10 border border-green-400/20 rounded-full">
