            ...
            <motion.div className="grid md:grid-cols-3 gap-6 p-6">
                {projectData.map((project, index) => (
                    <motion.div 
                        ...
                        className="w-96 min-h-[250px] bg-black border border-green-500 rounded-lg shadow-sm transition-transform duration-300 hover:scale-105 hover:border-[#00ffcc] hover:shadow-[0_0_15px_rgba(0,255,204,0.8)]"
                    >
                        <div className="p-6">
